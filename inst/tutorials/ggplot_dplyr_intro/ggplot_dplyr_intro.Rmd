...
Add a `facet` to the previous histogram so there is a different histogram for each s`pecies`. Make it so there is one column of plots. How would you compare the distributions?
